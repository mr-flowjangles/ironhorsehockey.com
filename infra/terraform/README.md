...
This folder is the home for Terraform modules that deploy Iron Horse Hockey to AWS. Currently empty — modules are defined when deployment becomes real (typically a late milestone in `docs/07-build-plan.md`).
